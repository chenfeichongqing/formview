package com.github.chenfeichongqing.formview.base;
...
public abstract class FormView<T> extends FrameLayout implements FormViewInterface {
    ...
    private int rightImageLeftMargin;
    ...
    protected void setRightMargin(View view, int marginleft ,int marginright) {
    ...
    protected void setRightMargin(View view, int marginright) {
        MarginLayoutParams layoutParams = (MarginLayoutParams) view.getLayoutParams();
        layoutParams.rightMargin = marginright;
        view.setLayoutParams(layoutParams);
    }
    ...
    private void initIvRight(Context context) {
        setRightMargin(ivRight, rightImageLeftMargin,rightImageRightMargin);
